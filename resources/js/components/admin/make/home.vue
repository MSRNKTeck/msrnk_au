<template>
	<div class="row justify-content-center">
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">Make</div>
				<div class="card-body">
					    ...
					    <div class="modal-dialog">
					      <div class="modal-content">
					        ...
					        <div class="modal-header">
					          <h4 class="modal-title">Create new Make</h4>
					          <button type="button" class="close" data-dismiss="modal">&times;</button>
					        </div>
					        
					        <!-- Modal body -->
					        <div class="modal-body">
					          <form @submit.prevent="addMake">
...
<script>
	export default {
		...
		created(){
			let uri = 'http://localhost:8000/api/make';
		...
		methods:{
			addMake(){
				let uri = 'http://localhost:8000/api/make_store';
